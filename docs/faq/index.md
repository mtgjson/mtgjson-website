...
> ```
>
> See the [official Scryfall documentation](https://scryfall.com/docs/api/images) for more information about different image variants, formats and pathing rules. If you are serving large amounts of images, Scryfall requests that you cache your own copy of the imagery.
>
> #### Gatherer Imagery
>
