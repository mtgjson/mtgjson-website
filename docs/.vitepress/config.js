...
export default {
  ...
  head: [
    ...
    [
      'link',
      { rel: 'apple-touch-icon', href: '/favicons/apple-icon-114x114.png', sizes: '114x114', type: 'image/png' },
    ],
    [
      'link',
      { rel: 'apple-touch-icon', href: '/favicons/apple-icon-120x120.png', sizes: '120x120', type: 'image/png' },
    ],
    [
      'link',
      { rel: 'apple-touch-icon', href: '/favicons/apple-icon-144x144.png', sizes: '144x144', type: 'image/png' },
    ],
    [
      'link',
      { rel: 'apple-touch-icon', href: '/favicons/apple-icon-152x152.png', sizes: '152x152', type: 'image/png' },
    ],
    [
      'link',
      { rel: 'apple-touch-icon', href: '/favicons/apple-icon-180x180.png', sizes: '180x180', type: 'image/png' },
    ],
