...
export default {
  ...
  data() {
    return {
      ...
      projectMsg:
        'Don\'t see your project? Join the <a href="https://discord.gg/74GUQDE" target="_blank">Discord</a> and let us know or open an issue at <a href="https://github.com/mtgjson/mtgjson-website/issues" target="_blank">GitHub</a>. We\'ll be happy to add it to this list.',
    };
  },
  computed: {
    patrons() {
